...
def evaluate_evo(poses_gt, poses_est, plot_dir, label, monocular=False):
    ...
    # Display ATE in green color
    rich.print(f"[bold green]ATE: {ape_stat:.4f}[/bold green]")
...
def eval_rendering(
    ...
    # Display PSNR in yellow color
    rich.print(f"[bold yellow]PSNR: {output['mean_psnr']:.4f}[/bold yellow]")
